...
WebServer::WebServer(
    int port, int trig_mode, int timeout_ms, bool optlinger,
    ...
    port_(port), timeout_ms_(timeout_ms), optlinger_(optlinger), is_close_(false),
    ...
    SqlConnPool::Instance()->Init("localhost", sql_port, sql_user, sql_pwd, dbname, conn_pool_num);
